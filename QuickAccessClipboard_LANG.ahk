...
this["TypeChangeCaseHelp"] := "Select the case you want to apply to the Clipboard content: Lower case, Upper case, Title case (upper case first letter of each word) or Toggle case."
...
this["TypeFind"] := "Find"
this["TypeFindHelp"] := "Type the text or characters to search. ~1~`n`nSelect the options to search for exact case match or full words only.`n"
