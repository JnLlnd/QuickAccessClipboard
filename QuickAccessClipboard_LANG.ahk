...
this["DialogAdd"] := "Add"
this["DialogAddEditRuleTitle"] := "~4~ Rule: ~1~ - ~2~ ~3~"
this["DialogAddEditRuleTitleForEditor"] := "Edit: ~1~ - ~2~ ~3~"
...
this["DialogCancelPromptRules"] := "Discard changes to active rules?"
this["DialogCancelTitle"] := "Cancel - ~1~ ~2~"
this["DialogCaseType1"] := "Lower case (all letters converted to lower case)"
this["DialogCaseType2"] := "Upper case (all letters converted to capitals)"
this["DialogCaseType3"] := "Title case (first letter of each word converted to capital)"
this["DialogCaseType4"] := "Sentence case (first letter of each sentence or line converted to capital)"
this["DialogCaseType5"] := "Toggle case (or Reverse case, each letter converted to its opposite case)"
...
this["DialogFindNext"] := "Find next"
this["DialogFindPrevious"] := "Find previous"
...
this["GuiSave"] := "Save"
this["GuiSaveEditor"] := "Save to Clipboard"
...
this["MenuRestoreClipboard"] := "Restore Clipboard"
this["MenuRule"] := "Rule"
...
this["MenuRunAtStartupEditor"] := "Display Editor window at startup"
this["MenuRunAtStartupRules"] := "Display Rules Manager window at startup"
...
this["MenuSelectRestoreClipboardHotkeyKeyboard"] := "Select Restore Clipboard keyboard hotkey"
this["MenuSelectRestoreClipboardHotkeyMouse"] := "Select Restore Clipboard Mouse button"
...
this["OptionsPopupHotkeyTitles"] := "~1~ Rules Mouse button|~1~ Rules Keyboard shortcut|~1~ Editor Mouse button|~1~ Editor Keyboard shortcut|Restore Clipboard Mouse button|Restore Clipboard Keyboard shortcut"
this["OptionsPopupHotkeyTitlesSub"] := "This mouse button will pop the ~1~ Rules manager.|This hotkey will pop the ~1~ Rules manager.|This mouse button will pop the ~1~ Editor.|This hotkey will pop the ~1~ Editor.|This mouse button will restore the content of the Clipboard before the last execution of QAC rule(s).|This hotkey will restore the content of the Clipboard before the last execution of QAC rule(s)."
this["ReloadPrompt"] := "Hotkey changed. Do you want to reload ~1~ now?"
this["RulesDisabled"] := "~1~ rules disabled (~2~ seconds timeout)"
this["RulesNotUpdated"] := "~1~ rules *NOT* updated..."
this["RulesRemovedRestore"] := "~1~ rules removed and Clipboard restored..."
this["RulesRemovedTimeout"] := "~1~ rules removed after ~2~ seconds timeout..."
...
this["TypeChangeCaseHelpClipboard"] := "Select the case you want to apply to the Clipboard's content: Lower case, Upper case, Title case (upper case first letter of each word), Toggle case or Sentence case."
this["TypeChangeCaseHelpEditor"] := "Select the case you want to apply to the Editor's content: Lower case, Upper case, Title case (upper case first letter of each word), Toggle case or Sentence case."
this["TypeConvertFormat"] := "Convert format"
this["TypeConvertFormatHelpClipboard"] := "This will convert the Clipboard's content to selected format. Other formats in the Clipboard will be deleted. Only ""Text"" format is supported at this time."
this["TypeEncodingHelp"] := "Use backtick sequences ``t for tab and ``n for end-of-line (enter ```` to search for `` alone)."
this["TypeFind"] := "Find"
this["TypePrefix"] := "Prefix"
this["TypePrefixHelpClipboard"] := "Type the text or the characters to add at the beginning of the Clipboard. ~1~`n`nIndicate if this rule is applied to each line of the Clipboard (instead of its whole content).`n"
this["TypePrefixHelpEditor"] := "Type the text or the characters to add at the beginning of each line of the Editor's content.`n"
this["TypeReplace"] := "Find and replace"
this["TypeReplaceHelpClipboard"] := "Type the text or characters to search in the Clipboard and the replacement characters. ~1~`n`nSelect the options to search for exact case match or full words only.`n"
this["TypeSort"] := "Sort"
this["TypeSortHelpClipboard"] := "Without any option, all the lines of the Clipboard will be sorted in alphabetical order. Optionaly, you can enable one or more of these special options to change the Sort command result."
...
this["TypeSubStringHelp2"] := "• From: the start, a specific position or the beginning/end of specified text (w/o offset).`n• To: the end, a specified length from start position, a specified position before the end or the beginning/end of specified text (w/o offset).`n"
this["TypeSubStringHelp3Clipboard"] := "• ~1~`n• Indicate if this rule is applied to each line of the Clipboard (instead of its whole content).`n"
this["TypeSubStringHelpClipboard"] := "Trim the beginning and/or end of the Clipboard content by setting the start and end positions of the content to keep using one of the following methods.`n"
this["TypeSubStringHelpEditor"] := "Trim the beginning and/or end of each line of the Editor's content by setting the start and end positions of the content to keep using one of the following methods.`n"
this["TypeSuffix"] := "Suffix"
this["TypeSuffixHelpClipboard"] := "Type the text or the characters to add at the end of the Clipboard content. ~1~`n`nIndicate if this rule is applied to each line of the Clipboard (instead of its whole content).`n"
this["TypeSuffixHelpEditor"] := "Type the text or the characters to add at the end of each line of the Editor's content.`n"
