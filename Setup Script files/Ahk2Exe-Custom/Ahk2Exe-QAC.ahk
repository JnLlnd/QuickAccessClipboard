...
; strBranch := "" ; pour prod
strBranch := A_Args[2]
AhkFile := "C:\Dropbox\AutoHotkey\QuickAccessClipboard\QuickAccessClipboard.ahk"
ExeFile := "C:\Temp\QAC_Compile\Build" . strBranch . "\QuickAccessClipboard-" . intBits . "-bit.exe"
IcoFile := "C:\Dropbox\AutoHotkey\QuickAccessClipboard\Distribution-files\QuickAccessClipboard" . strBranch . ".ico"
CustomBinFile := true
BinFile := "C:\Dropbox\AutoHotkey\QuickAccessClipboard\Setup Script files\Ahk2Exe-Custom\Unicode " . intBits . "-bit-JL.bin"
