...
this["TypeChangeCaseHelpClipboard"] := "Select the case you want to apply to the Clipboard's content: Lower case, Upper case, Title case (upper case first letter of each word) or Toggle case."
this["TypeChangeCaseHelpEditor"] := "Select the case you want to apply to the Editor's content: Lower case, Upper case, Title case (upper case first letter of each word) or Toggle case."
