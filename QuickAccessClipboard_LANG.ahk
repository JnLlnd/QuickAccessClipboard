...
this["MenuRunAtStartupQAC"] := "Launch QAC with Windows"
...
this["TypeEncodingHelp"] := "Use backtick sequences ``t for tab and ``n for end-of-line (use ```` to enter `` alone)."
this["TypeFind"] := "Find"
...
this["TypeSubStringHelpClipboard"] := "Select the text you want to KEEP in the Clipboard. Pressing Go will trim unwanted text from the beginning or end of the text you want to keep.`n"
this["TypeSubStringHelpEditor"] := "Select the text you want to KEEP on each line in the editor. Pressing Go will trim unwanted text from the beginning or end of the text you want to keep.`n"
